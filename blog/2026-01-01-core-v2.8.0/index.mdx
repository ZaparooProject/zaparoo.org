...
## [Zap Link](/docs/zapscript/syntax#zap-links) Improvements
...
- [Zap Link](/docs/zapscript/syntax#zap-links) hosts that don't support the protocol are automatically re-checked after 30 days.
