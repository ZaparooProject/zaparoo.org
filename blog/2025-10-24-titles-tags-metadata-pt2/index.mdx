...
description: Part 2 of the deep dive into Zaparoo's game matching system, covering the tags system that makes cards portable across devices and platforms.
tags: [core]
authors: [wizzo]
---
...
5. Prefer file extensions that are better quality (based on the [launcher definition](/docs/features/launchers/))
...
If you want to dive deeper into the technical details of how this system works, check out the [Title Normalization and Matching System documentation](/docs/core/contributing/media-titles/) which covers the implementation in depth.
