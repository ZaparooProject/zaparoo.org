...
description: "Two new card templates added to Zaparoo Designer plus an update to an existing one: new options for designing printable NFC cards."
tags: [software]
authors: wizzo
---

![Three Zaparoo game card labels using the Game Card template](cover.png)
...
A huge thank you to [Asturur](https://github.com/asturur) and [Tim Wilsie](https://timwilsie.com/) for their continued contributions to the Designer. There are also some upcoming changes to the Designer itself, which will greatly improve the experience designing cards and creating your own templates. Stay tuned for more information on that!

## Game Cards

First up is the Game Card template by [Tim Wilsie](https://timwilsie.com/). This gorgeous template is first up in the long awaited post-TapTo design era. If you were waiting for a new template to start your Zaparoo collection, you can START RIGHT NOW!
