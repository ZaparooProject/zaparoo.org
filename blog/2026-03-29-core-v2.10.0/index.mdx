...
description: "Zaparoo Core v2.10.0: Kodi and RetroArch playback controls, significantly faster indexing and search, new ZapScript screenshot and wallpaper commands."
tags: [software, core]
authors: [wizzo]
---
...
- **[Ignore on connect](/docs/core/config/readers/#ignore_on_connect)** — new config option to suppress the first token read from each newly-connected reader. Stops accidental launches from cards left sitting on readers
