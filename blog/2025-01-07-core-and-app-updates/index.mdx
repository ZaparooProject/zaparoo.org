---
slug: core-and-app-updates
title: "Core v2.1.0 and App v1.4.1 updates"
description: "Zaparoo Core v2.1.0 and App v1.4.1: finalizes the TapTo to Zaparoo transition with new features and bug fixes. Includes hotfix v2.1.1 for MiSTer migration."
tags: [software, core]
authors: wizzo
---
...
<Button
  ...
  label="GitHub"
  link="https://github.com/ZaparooProject/zaparoo-core/releases/tag/v2.1.0"
  variant="primary"
/>
