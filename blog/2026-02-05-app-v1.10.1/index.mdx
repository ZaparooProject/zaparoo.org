...
description: "Zaparoo App v1.10.1: optional Zaparoo Online accounts, over-the-air updates, NFC handling fixes, and automatic device discovery on local networks."
tags: [software]
authors: [wizzo]
---

:::warning Pro Purchase Issue on Android

Some Android users are reporting that their Pro purchase is no longer active after updating. First, try to go to **Settings > Advanced** and press the **"Restore purchases"** button. If that doesn't work, email me directly at support@zaparoo.com and I'll sort it out.
