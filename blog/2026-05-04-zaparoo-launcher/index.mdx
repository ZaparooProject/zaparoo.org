...
The release linked below is not the newest Launcher build. A new stable release is still a couple of weeks away, but development builds shared in Discord already include significant improvements. Join the [Zaparoo Discord](https://zaparoo.org/discord) and check the `#development` channel before installing from the links on this page.
