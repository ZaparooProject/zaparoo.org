...
Core v2.13.0 adds [MiSTer Companion XML support](/docs/frontend/scraping/) to the `gamelist.xml` scraper. The [Frontend scraping docs](/docs/frontend/scraping/) cover Boss's Basic Batch, ZapScraper, and Skraper setup options.
