...
## [Playtime Limits & Parental Controls](/docs/features/playtime/)

A new [time management system](/docs/features/playtime/) lets you set daily playtime limits, track gaming sessions, and automatically enforce limits with grace period notifications. Perfect for parents who want to manage screen time.
