...
description: "Major ZapEsp32 release with a completely overhauled UI: the open-source wireless NFC reader built on ESP32, now easier to set up and more powerful."
tags: [hardware]
authors: wizzo
---

![ZapEsp32 NFC reader next to a Steam Deck and a mini PC](cover.png)
...
<div class="embed-container">
  <iframe
    ...
    title="ZapESP32 interface demonstration"
    frameborder="0"
    allowfullscreen
  ></iframe>
</div>
