...
description: "Zaparoo App v1.7.0: new in-app mappings editor, ZapScript editor, and bug fixes. Create and manage scan-to-action mappings without editing files."
tags: [software]
authors: [wizzo]
---
