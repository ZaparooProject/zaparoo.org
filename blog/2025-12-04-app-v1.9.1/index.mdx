...
description: "Zaparoo App v1.9.1: companion release for Core v2.7.0 with title ID support, playtime limits, onboarding tour, log viewer, and shake-to-launch."
tags: [software]
authors: [wizzo]
---
...
Full support for the new [playtime limits](/docs/features/play-controls/#playtime-limits) feature from Core v2.7.0. The app lets you:
