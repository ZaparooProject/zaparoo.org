...
- **Launch Guard support** - confirm or dismiss staged [Launch Guard](/docs/features/launch-guard/) tokens from the app
...
[Launch Guard](/docs/features/launch-guard/) also has app support now. When Core stages a token, the app shows a modal with the token details and **Confirm**/**Hide** actions. **Settings > Play Controls** can enable Launch Guard and adjust the timeout and delay without editing `config.toml` by hand.
