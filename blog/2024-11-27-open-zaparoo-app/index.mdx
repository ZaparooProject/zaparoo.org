...
description: The Zaparoo mobile app is now open source. Source code available for contributors and as a starting point for building your own Zaparoo-based apps.
tags: [software]
authors: wizzo
---

![Phone running Zaparoo app connected to a MiSTer FPGA showing the game menu](cover.jpg)
...
The app was originally created by myself and [Tim Wilsie](https://timwilsie.com/). We've been stoked to see so many people enjoying the app and we hope this move will help it grow even further.
