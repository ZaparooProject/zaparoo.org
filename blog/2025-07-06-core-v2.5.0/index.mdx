...
description: "Zaparoo Core v2.5.0: NAS support, new ZapScript features, and bug fixes from the previous release."
tags: [software, core]
authors: [wizzo]
---
...
- Playlist loading ZapScript now supports [inline playlist definitions](/docs/zapscript/playlist/).
- Improved [zap link](/docs/zapscript/syntax#zap-links) support with better support detection, cached zaps and simpler payloads.
