...
- [Hold mode](/docs/core/config/readers/#scan-mode) now stays tied to the token that launched the game. Scanning and removing a command card no longer closes the active game or resets its exit countdown.
