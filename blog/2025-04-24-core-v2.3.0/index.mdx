...
description: "Zaparoo Core v2.3.0: stable Batocera support, revamped playlist feature, and a range of smaller improvements."
tags: [software, core]
authors: [wizzo]
---
...
- Added support for searching `all` system in [launch.random command](/docs/zapscript/launch#launchrandom).
- Added feature to allow setting a [portable directory](/docs/core/config) for Zaparoo config and data.
- Added support for scanning subfolders in [mappings folder](/docs/features/mappings/).
