---
slug: tapto-to-zaparoo
title: "TapTo to Zaparoo"
description: TapTo is being rebranded to Zaparoo. An explanation of why the name is changing, what it means for the project, and what stays the same.
authors: wizzo
---

![Zaparoo logo, kangaroo silhouette with lightning bolt and wordmark](cover.png)
...
Big thank you to [Tim Wilsie](https://timwilsie.com/) for designing the new brand artwork for the project! Another big thank you to [Ranny Snice](https://x.com/RannySnice) who designed the original TapTo logo and was so kind as to let us use it this year.
