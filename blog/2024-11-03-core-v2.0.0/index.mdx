...
description: "TapTo Core v2.0.0: major release with breaking changes ahead of the TapTo to Zaparoo rebrand. Upgrade the TapTo Life app before connecting."
tags: [software, core]
authors: wizzo
---
...
<Button
  ...
  label="GitHub"
  link="https://github.com/ZaparooProject/tapto/releases/tag/v2.0.0"
  variant="primary"
/>
