...
Zaparoo Core v2.6.0 is now available! This release significantly expands [Batocera](/docs/platforms/batocera) support with over 100 additional systems plus [Kodi](/docs/platforms/libreelec) integration, adds support for TV shows and music to Kodi, new experimental [TTY2OLED display](/docs/core/drivers#tty2oled) support, major [NFC performance improvements](/docs/readers/nfc/) plus heaps of other features and bug fixes.
...
RetroBat is now supported as a launcher on [Windows](/docs/platforms/windows#retrobat). Support should be automatic as long as RetroBat is running while you updated the media database.

### Steam Integration Improvements

Steam ([Windows](/docs/platforms/windows#steam) and [SteamOS](/docs/platforms/steamos)) support has been significantly improved:
