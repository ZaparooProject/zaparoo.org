...
We've significantly expanded [Batocera](/docs/platforms/batocera) system support in this release, adding over 100 launchers which should just about match Batocera's own count. This change also added 17 new [system definitions](/docs/systems) that work with [custom launchers](/docs/core/launchers) including Atari ST, CPS1-3, Coleco Adam, Commander X16, FM7, FM Towns, GP32, PC88/98, Pico-8 and TIC-80. Special thanks to [Anime0t4ku](https://github.com/Anime0t4ku) for compiling all the information required to add these!
...
- [MIFARE tags](/docs/core/tokens) are now 100% supported, read and write, and they no longer need to be formatted beforehand
...
- Experimental support for [FeLiCa tags](/docs/core/tokens) (I followed the spec but I don't own any of these cards so I don't know if it works!)
...
- Fixed TUI improvements including [media DB update](/docs/core/web-ui) page freezing
