...
description: "Zaparoo Core v2.6.0: expanded Batocera support with 100+ new systems, Kodi TV show and music integration, TTY2OLED display support, and NFC performance improvements."
tags: [software, core]
authors: [wizzo]
---

Zaparoo Core v2.6.0 is now available! This release significantly expands [Batocera](/docs/platforms/batocera) support with over 100 additional systems plus [Kodi](/docs/platforms/libreelec) integration, adds support for TV shows and music to Kodi, new experimental [TTY2OLED display](/docs/readers/tty2oled) support, major [NFC performance improvements](/docs/readers/nfc/) plus heaps of other features and bug fixes.
...
- [MIFARE tags](/docs/tokens/nfc/) are now 100% supported, read and write, and they no longer need to be formatted beforehand
...
- Experimental support for [FeLiCa tags](/docs/tokens/nfc/) (I followed the spec but I don't own any of these cards so I don't know if it works!)
...
There are now pacman packages built for Batocera, available in the GitHub releases page if you want to try them out. Hopefully we can get these officially listed in the official Batocera content downloader.
...
Steam ([Windows](/docs/platforms/windows) and [SteamOS](/docs/platforms/steamos)) support has been significantly improved:
...
- Fixed [custom launcher](/docs/features/launchers/) functionality issues
- Fixed several Batocera platform bugs including system metadata display and path normalization
- Fixed launch.random commands with arguments in format "system/\*"
- Fixed system default overrides to properly respect [configuration](/docs/core/config)
- Fixed TUI improvements including [media DB update](/docs/app/web/) page freezing
- Fixed Batocera API connection retry logic for better reliability
