...
A few tags are set by you rather than read from a filename. Favorites, likes, dislikes, and play later come from the [Zaparoo App](../app/index.md#library), or from your Zaparoo Online account through [Library sync](../online/index.md#library-sync). [Frontend](../frontend/index.mdx) sets favorites. They filter like any other tag:
