...
This method will list values set in the [Config File](../config/index.md). Some config file options may be omitted which are not appropriate to be read or written remotely.
