...
Metadata packs provide ready-made artwork and `gamelist.xml` files for compatible ROM sets. They may not match custom naming, ROM hacks, or unusual library layouts.
...
[Big Blue's Bundle](https://www.dropbox.com/scl/fi/mu972fyxuc5j0xxddieio/Big-Blue-s-Bundle.zip?rlkey=9pkvia8yxifctzpkc75rb4p2k&st=nm73ur44&e=1&dl=0) is a metadata and artwork pack from BigBlue709 made specifically for MiSTer's Arcade system.
