...
The TUI is built into Core on MiSTer, Batocera, Linux, SteamOS, Bazzite, ChimeraOS, LibreELEC, RePlayOS, and macOS. Windows runs Core from the system tray instead, and MiSTeX has no TUI; both use the App or Web UI for settings.
