---
title: "ZapEsp32 Configuration"
---

Enter `zapesp.local` into your browser address bar to access the ZapEsp32 Web UI.

Click the **`ESP32`** menu item to enable modules/components & change the default ESP32 GPIO Pins according to how you have built your ZapEsp32. If you have used suggested default pins, make sure the pin numbers match as per your ESP32 SOC type ([ESP32](../ESP32-Default-GPIO-Pins) , [ESP32-S3](../ESP32%E2%80%90S3-Default-GPIO-Pins), [ESP32-S2 Mini](../ESP32%E2%80%90S2-Mini-Default-GPIO-Pins))  
  
![ESP32 Config](https://raw.githubusercontent.com/ZaparooProject/zaparoo-esp32/main/wikires/WebUI_ESP32.png)
