...
The MQTT reader connects to an MQTT broker and executes [ZapScript](/docs/zapscript/) commands received from subscribed topics. This enables integration with home automation systems like [Home Assistant](https://www.home-assistant.io/) and other MQTT-based services.
...
The MQTT reader requires manual configuration in your [config file](/docs/core/config). Auto-detection is not supported.
...
The `url` should match your broker address (without the topic path).
