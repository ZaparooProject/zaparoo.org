...
TeensyROM is a custom cartridge for the Commodore 64 that adds many features, including support for the [PN532 NFC reader](../readers/nfc/pn532-usb.md). Take a look at the [NFC guide](https://github.com/SensoriumEmbedded/TeensyROM/blob/main/docs/NFC_Loader.md) on the TeensyROM GitHub for more information.
