...
Currently, you must use shell scripts to launch media on macOS. See the [Linux page](./linux#launchers) for more information on how to set up launchers this way.
