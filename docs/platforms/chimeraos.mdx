...
Currently, ChimeraOS only supports launching shell scripts. You must create shell scripts to launch games, applications, or media. See the [Linux page](./linux.mdx#launchers) for more information on how to set up launchers this way.
