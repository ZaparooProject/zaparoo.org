...
Instead, you use [mappings](../../core/mappings.md) to assign an action to each figure based on its UID. Every physical Disney Infinity figure has a unique UID, so each one is mapped individually.
