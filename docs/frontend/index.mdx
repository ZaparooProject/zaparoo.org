...
Frontend can launch anything Core can already launch on MiSTer, including standard games, MGL files and supported special launchers. For platform-specific launcher details, see the [MiSTer launcher documentation](../platforms/mister/launchers.md).
